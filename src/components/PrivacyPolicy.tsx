  ...
  return (
    <div className="privacy-policy">
      <div className="privacy-content">
        ...
        <br />
        <p>
          For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information, including but not limited to First Name, Last Name, Email Address, User ID, Password, Device Token, Device Key, Device Type, OS Version, App Version, Platform, Account Status, Account Creation Date, Last Activity, Notification Preferences, Meal Data, Favorite Meal Items, User Preferences, App Settings, Authentication Tokens, Login History. The information that the Service Provider request will be retained by them and used as described in this privacy policy.
        </p>
        ...
        <p>
          The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you'd like them to delete User Provided Data that you have provided via the Application, please contact them at alphabornapps@gmail.com and they will respond in a reasonable time.
        </p>
        ...
        <p>
          If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at alphabornapps@gmail.com.
        </p>
