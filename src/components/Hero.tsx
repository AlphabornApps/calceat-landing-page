        ...
        <div className="hero-grid">
          ...
          <div className="hero-content">
            ...
            <div className="hero-actions animate-fade-in-up animate-delay-300">
              <a href="https://apps.apple.com/app/calceat/id6749812271" target="_blank" rel="noopener noreferrer" className="btn btn-primary btn-large">
              ...
              <a href="https://play.google.com/store/apps/details?id=com.alphaborn.calceat" target="_blank" rel="noopener noreferrer" className="btn btn-secondary btn-large">
                <svg className="btn-icon" viewBox="0 0 24 24" fill="currentColor">
